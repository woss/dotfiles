...
let g:neosnippet#snippets_directory='~/.config/repos/github.com/Shougo/neosnippet-snippets/neosnippets, ~/.config/repos/github.com/matthewsimo/angular-vim-snippets/snippets'
